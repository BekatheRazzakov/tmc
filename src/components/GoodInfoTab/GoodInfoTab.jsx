...
const GoodInfoTab = ({good, goodLoading, goodError, snackBarOpen, handleClose}) => {
  return (
    <>
      <Paper className="single-good-outer-paper" elevation={3}>
        {goodLoading ? <>
          <Skeleton variant="text" sx={{fontSize: '8rem', maxWidth: '200px', transform: 'unset',}}/>
          <Skeleton variant="text" sx={{fontSize: '1.2rem', maxWidth: '200px', transform: 'unset'}}/>
          <Skeleton variant="text" sx={{fontSize: '1rem', maxWidth: '200px', transform: 'unset'}}/>
        </> : <>
          <img
